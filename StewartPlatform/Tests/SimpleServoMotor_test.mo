...
model SimpleServoMotor_test
  Components.SimpleServoMotor simpleServoMotor(sm_initialTorqueFixed = true)  annotation(
...
equation
  ...
  connect(simpleServoMotor.axisControlBus, refToBus.axisControlBus) annotation(
    Line(points = {{-20, 0}, {-8, 0}, {-8, 0}, {-8, 0}}, color = {255, 204, 51}, thickness = 0.5));
  connect(inertia.flange_a, simpleServoMotor.flange) annotation(
