...
model simplifiedModel_test
  ...
  StewartPlatform.Components.SimplePlatform simplePlatform(_enforceStates = false, _useQuaternions = false, fixInitAcceleration = false, fixInitAngularAcc = false, fixInitAngularVel = false, fixInitOrientation = false, fixInitPosition = false, fixInitVelocity = false) annotation(
    Placement(visible = true, transformation(origin = {-3.55271e-15, 80}, extent = {{-20, 20}, {20, -20}}, rotation = 0)));
  StewartPlatform.Components.SimpleBase simpleBase annotation(
    Placement(visible = true, transformation(origin = {0, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic1(n = {0, 0, 1}, s(fixed = true, start = initialLength[1]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {-70, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic2(n = {0, 0, 1}, s(fixed = true, start = initialLength[2]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {-40, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic3(n = {0, 0, 1}, s(fixed = true, start = initialLength[3]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {-10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic4(n = {0, 0, 1}, s(fixed = true, start = initialLength[4]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {10, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic5(n = {0, 0, 1}, s(fixed = true, start = initialLength[5]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {40, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic6(n = {0, 0, 1}, s(fixed = true, start = initialLength[6]), stateSelect = StateSelect.always, useAxisFlange = true) annotation(
    Placement(visible = true, transformation(origin = {70, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
...
protected
  final parameter Real leg[6, 3] = legsDirections(simpleBase.base, simplePlatform.platform, simplePlatform.initPlatformPosition, {1, 2, 3}, simplePlatform.initPlatformAngles, true) "Initial legs direction resolved in base frame";
  final parameter SI.Length initialLength[6] = legsLength(simpleBase.base, simplePlatform.platform, simplePlatform.initPlatformPosition, {1, 2, 3}, simplePlatform.initPlatformAngles) "Initial legs length";
...
equation
  connect(simpleBase.frame_b[1], universal1.frame_a) annotation(
    Line(points = {{0, -66}, {-70, -66}, {-70, -40}, {-70, -40}}, color = {95, 95, 95}));
  connect(simpleBase.frame_b[2], universal2.frame_a) annotation(
    Line(points = {{0, -66}, {-40, -66}, {-40, -40}, {-40, -40}}, color = {95, 95, 95}));
  connect(simpleBase.frame_b[3], universal3.frame_a) annotation(
    Line(points = {{0, -66}, {-10, -66}, {-10, -40}, {-10, -40}}, color = {95, 95, 95}));
  connect(simpleBase.frame_b[4], universal4.frame_a) annotation(
    Line(points = {{0, -66}, {10, -66}, {10, -40}, {10, -40}}, color = {95, 95, 95}));
  connect(simpleBase.frame_b[5], universal5.frame_a) annotation(
    Line(points = {{0, -66}, {40, -66}, {40, -40}, {40, -40}}, color = {95, 95, 95}));
  connect(simpleBase.frame_b[6], universal6.frame_a) annotation(
    Line(points = {{0, -66}, {70, -66}, {70, -40}, {70, -40}}, color = {95, 95, 95}));
//
...
//
  connect(simplePlatform.frame_b[1], spherical1.frame_b) annotation(
    Line(points = {{0, 66}, {-70, 66}, {-70, 60}, {-70, 60}}, color = {95, 95, 95}));
  connect(simplePlatform.frame_b[2], spherical2.frame_b) annotation(
    Line(points = {{0, 66}, {-40, 66}, {-40, 60}, {-40, 60}}, color = {95, 95, 95}));
  connect(simplePlatform.frame_b[3], spherical3.frame_b) annotation(
    Line(points = {{0, 66}, {-10, 66}, {-10, 60}, {-10, 60}}, color = {95, 95, 95}));
  connect(simplePlatform.frame_b[4], spherical4.frame_b) annotation(
    Line(points = {{0, 66}, {10, 66}, {10, 60}, {10, 60}}, color = {95, 95, 95}));
  connect(simplePlatform.frame_b[5], spherical5.frame_b) annotation(
    Line(points = {{0, 66}, {40, 66}, {40, 60}, {40, 60}}, color = {95, 95, 95}));
  connect(simplePlatform.frame_b[6], spherical6.frame_b) annotation(
    Line(points = {{0, 66}, {70, 66}, {70, 60}, {70, 60}}, color = {95, 95, 95}));
//
