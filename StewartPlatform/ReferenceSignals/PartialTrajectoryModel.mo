...
partial model PartialTrajectoryModel "This model collects all the common parameters and interfaces of the trajectory models"
  ...
  //Parameters
    ...
    parameter Modelica.Mechanics.MultiBody.Types.Axis n_start={1,0,0}
      ...
      enable=rotationType_start == Modelica.Mechanics.MultiBody.Types.RotationTypes.RotationAxis));
    ...
    parameter Modelica.Mechanics.MultiBody.Types.Axis n_x_start={1,0,0}
      ...
      enable=rotationType_start == Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors));
    ...
    parameter Modelica.Mechanics.MultiBody.Types.RotationSequence sequence_start(min={1,1,1},max={3,3,3}) = gp.initSequence "Start: sequence of rotation axes"
      ...
      enable=rotationType_start == Modelica.Mechanics.MultiBody.Types.RotationTypes.PlanarRotationSequence));
    ...
    parameter Modelica.Mechanics.MultiBody.Types.Axis n_stop=n_start
      ...
      enable=rotationType_stop == Modelica.Mechanics.MultiBody.Types.RotationTypes.RotationAxis));
    parameter NonSI.Angle_deg angle_stop=angle_start
      "Stop: angle to rotate base frame around axis n_stop into platform frame"
      annotation(Dialog(group="if rotationType_stop = RotationAxis", tab="Orientation", enable=rotationType_stop ==  Modelica.Mechanics.MultiBody.Types.RotationTypes.RotationAxis));
    ...
    parameter Modelica.Mechanics.MultiBody.Types.Axis n_x_stop=n_x_start
      ...
      annotation(Evaluate=true, Dialog(group="if rotationType_stop = TwoAxesVectors", tab="Orientation", enable=rotationType_stop == Modelica.Mechanics.MultiBody.Types.RotationTypes.TwoAxesVectors));
    ...
    parameter Modelica.Mechanics.MultiBody.Types.RotationSequence sequence_stop(min={1,1,1},max={3,3,3}) = sequence_start "Stop: sequence of rotation axes"
      ...
      enable=rotationType_stop == Modelica.Mechanics.MultiBody.Types.RotationTypes.PlanarRotationSequence));
