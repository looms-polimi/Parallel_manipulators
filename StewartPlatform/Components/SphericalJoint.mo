...
model SphericalJoint "Model of a spherical joint"
  extends StewartPlatform.Icons.SphericalJoint; // Icon

// Parameters
  parameter StewartPlatform.Types.SphericalJointParameters sphericalJointParameters "Parameters of the spherical joint";
