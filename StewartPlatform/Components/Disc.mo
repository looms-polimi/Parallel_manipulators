...
model Disc "Cylindrical disc used to model the base and the platform"
    extends StewartPlatform.Icons.Disc;
    
// Imports
    import StewartPlatform.Types.Direction;
...
// Parameters
    ...
    protected
        parameter SI.Position J[6,3] = StewartPlatform.Functions.jointsCoordinates(discParameters) "Coordinates of the joints";
...
// Models
    ...
    connect(fixedRotation1.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{20, 20}, {20, 20}, {20, 0}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation2.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{0, 40}, {0, 40}, {0, 0}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation3.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{-40, 40}, {-20, 40}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation4.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{-40, -40}, {-20, -40}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation5.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{0, -40}, {0, -40}, {0, 0}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation6.frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{20, -20}, {20, -20}, {20, 0}, {-20, 0}, {-20, 0}}));
    connect(frame_a, bodyCylinder.frame_a) annotation(
    Line(points = {{0, -100}, {-20, -100}, {-20, 0}, {-20, 0}}));
    connect(fixedRotation1.frame_b, frame_b[1]) annotation(
    Line(points = {{40, 20}, {40, 20}, {40, 100}, {0, 100}, {0, 100}}));
    connect(fixedRotation2.frame_b, frame_b[2]) annotation(
    Line(points = {{0, 60}, {0, 60}, {0, 100}, {0, 100}}));
    connect(fixedRotation3.frame_b, frame_b[3]) annotation(
    Line(points = {{-40, 60}, {-40, 60}, {-40, 100}, {0, 100}, {0, 100}}));
    connect(fixedRotation4.frame_b, frame_b[4]) annotation(
    Line(points = {{-40, -60}, {-60, -60}, {-60, 100}, {0, 100}, {0, 100}}));
    connect(fixedRotation5.frame_b, frame_b[5]) annotation(
    Line(points = {{0, -60}, {80, -60}, {80, 100}, {0, 100}, {0, 100}}));
    connect(fixedRotation6.frame_b, frame_b[6]) annotation(
    Line(points = {{40, -20}, {60, -20}, {60, 100}, {0, 100}, {0, 100}}));
end Disc;
