...
model TrapezoidalTrajectory "The output is the position of the platform to follow a line with a trapezoidal velocity profile"
  extends DeltaRobot.Icons.TrapezoidalTrajectory;
  ...
  //Variables
    ...
    final parameter SI.Time Ti= if case==1 then Ti_bar else -initialSpeed/ai+sqrt(0.5*initialSpeed^2+0.5*finalSpeed^2+ai*totalDistance)/ai
