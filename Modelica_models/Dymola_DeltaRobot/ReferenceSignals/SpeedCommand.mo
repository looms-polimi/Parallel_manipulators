...
model SpeedCommand "The outputs are three speed reference signals defined through interpolation of table's elements"
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable1(
    ...
    tableName="Speeds",
    columns=2:4,
    fileName="C:/Users/campa/Documents/MODELICA models/DeltaRobotDEFINITIVO/DeltaRobot/DataTables/SpeedCommand.txt",
    startTime=startTime) annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  Modelica.Blocks.Interfaces.RealOutput speedRef[3] "reference speeds in rad/s"
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable2(
    ...
    columns=2:4,
    fileName="C:/Users/campa/Documents/MODELICA models/DeltaRobotDEFINITIVO/DeltaRobot/DataTables/SpeedCommand.txt",
    startTime=startTime + combiTimeTable1.t_max + deltaTime) annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable3(
    ...
    columns=2:4,
    fileName="C:/Users/campa/Documents/MODELICA models/DeltaRobotDEFINITIVO/DeltaRobot/DataTables/SpeedCommand.txt",
    startTime=startTime + combiTimeTable1.t_max + combiTimeTable2.t_max + 2*deltaTime) annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=true), graphics={Text(
          ...
          textString="Speed")}),                                Diagram(coordinateSystem(preserveAspectRatio=true), graphics={Text(
