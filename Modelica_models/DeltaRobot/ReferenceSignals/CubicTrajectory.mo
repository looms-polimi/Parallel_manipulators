...
model CubicTrajectory  "The outputs are three reference values for the three actuators of a Delta robot to follow a line with a cubic eqution of motion"
  extends DeltaRobot.Icons.CubicTrajectory; // Icon
