...
model DeltaRobot_IdealActPos_PositionValidation
  ...
  DeltaRobot.ReferenceSignals.PickAndPlace pickAndPlace1(anticipation = 0.15, horizontalVerticalFinalSpeed = 0, horizontalVerticalInitialSpeed = 0, maxAccelerationHorizontal = 29.19, maxAccelerationVertical = 5.36, maxSpeedHorizontal = 2.277, maxSpeedVertical = 100, startTime = 0, verticalHorizontalFinalSpeed = 0, verticalHorizontalInitialSpeed = 0) annotation(
    Placement(visible = true, transformation(origin = {-90, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeltaRobot.ReferenceSignals.InverseKinematic inverseKinematic annotation(
    Placement(visible = true, transformation(origin = {-50, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeltaRobot.ReferenceSignals.SpeedCommand speedCommand(n = 3, startTime = 0.035)  annotation(
    Placement(visible = true, transformation(origin = {70, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeltaRobot.ReferenceSignals.TorqueCommand torqueCommand(n = 3, startTime = 0.035)  annotation(
    Placement(visible = true, transformation(origin = {70, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DeltaRobot.ReferenceSignals.PickAndPlace pickAndPlace2(anticipation = 0.04, maxAccelerationVertical = 17.5, maxSpeedVertical = 100, verticalHorizontalFinalSpeed = 1.1068, verticalHorizontalInitialSpeed = 1.1068)  annotation(
