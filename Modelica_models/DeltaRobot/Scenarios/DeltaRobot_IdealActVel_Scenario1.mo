...
model DeltaRobot_IdealActVel_Scenario1
  ...
  inner DeltaRobot.Components.GlobalParameters gp(initPlatformPos = {0.1, 0.1, -0.6})  annotation(
  ...
  DeltaRobot.Components.Platform platform(_enforceStates = false, fix_initPlatformAngularVel = false, fix_initPlatformOrientation = false, fix_initPlatformPos = false, fix_initPlatformVel = false, useGlobalParameters = true) annotation(
