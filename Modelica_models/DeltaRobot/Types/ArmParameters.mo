...
record ArmParameters "Parameters of a Delta Robot's arm"
    ...
    // Animation
    parameter SI.Distance cylinderLength = 1/30 "Length of cylinder representing the universal joint" annotation(Dialog(group="Animation"));
    parameter SI.Diameter cylinderDiameter = 1/30 "Diameter of cylinder representing the universal joint" annotation(Dialog(group="Animation"));
