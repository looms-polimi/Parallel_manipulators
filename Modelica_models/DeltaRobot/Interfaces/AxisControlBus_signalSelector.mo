...
model AxisControlBus_signalSelector "Connects or cuts the signals along the axis control bus"
  extends DeltaRobot.Icons.AxisControlBus_signalSelector; // Icon
...
// Models
  DeltaRobot.Interfaces.AxisControlBus axisControlBus_in annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 1.77636e-15}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  DeltaRobot.Interfaces.AxisControlBus axisControlBus_out annotation(Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 3.55271e-15}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
