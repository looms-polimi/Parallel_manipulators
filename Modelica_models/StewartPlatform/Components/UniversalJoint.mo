...
// Parameters
  ...
  parameter Boolean uj_initialAnglesFixed = false "=true, if you want to use joint angles as initial equation ('fixed' attributes)" annotation (Dialog(group="Initialization"), choices(checkBox=true));
  parameter Boolean uj_initialAngularVelFixed = false "=true, if you want to use angular velocities (=0) of the joint as initial equation ('fixed' attributes)" annotation (Dialog(group="Initialization"), choices(checkBox=true));
  parameter Boolean uj_initialAngularAccFixed = false "=true, if you want to use angular accelerations (=0) of the joint as initial equation ('fixed' attributes)" annotation (Dialog(group="Initialization"), choices(checkBox=true));

// Animation
  parameter SI.Distance uj_cylinderLength=1/10 "Length of cylinders representing the universal joint" annotation (Dialog(group="Animation"));
  parameter SI.Distance uj_cylinderDiameter=1/20 "Diameter of cylinders representing the universal joint" annotation (Dialog(group="Animation"));
...
// Models
  ...
  Modelica.Mechanics.MultiBody.Joints.Universal 
    universal(       
      ...
      cylinderDiameter=uj_cylinderDiameter,
      cylinderLength=uj_cylinderLength)
