...
model Leg_invDyn "Leg model for inverse dynamic"
...
// Models
  ...
  ServoMotor_invDyn servoMotor annotation(Placement(visible = true, transformation(extent = {{-34, 18}, {-14, 38}}, rotation = 0)));
