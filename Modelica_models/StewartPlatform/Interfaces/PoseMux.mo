...
model PoseMux "Shrink the variables of a 'Pose' connector"
  ...
  // Models
    ...
    Modelica.Blocks.Interfaces.IntegerOutput sequenceIn[3] annotation (Placement(visible = true, transformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0), iconTransformation(extent = {{-110, 40}, {-90, 60}}, rotation = 0)));
